...
var (
	...
	// fetched. Both fields are protected by limitsMutex.
...
// briefStatusErr renders a fetch error without ever including a raw HTTP
// response body (which, unlike this program's own error messages, is not
